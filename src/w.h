...
K an(K,I,K[3]),p9(S);    ZK INS,CUT;
#define go()             INS=p9(",/@[(0,2#x)^z;1;y]"),CUT=p9(",/((0,x,x+y)^z)0 2")
#define OP(o,i,x)        (p2(o,ki(i),x))
#define AN(f,i,yz...)    an(f,3,(K[3]){ki(i),yz})
#define tak(i,x)         x=OP(14,i,x)
