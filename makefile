#-fno-stack-protector
O=-fvisibility=hidden -flax-vector-conversions -fno-common -fno-asynchronous-unwind-tables -fno-stack-protector
WL=-Werror -pedantic -Wno-empty-body -Wno-variadic-macros -Wno-gnu-statement-expression \
	...
	-Wno-pointer-sign -Wno-int-conversion -Wno-gnu-empty-initializer -Wno-zero-length-array
...
tc: c
	@tcc -DNOLIBC=1 -std=c11 -otc $A src/?.c -Os
	@strip -s tc
	@ls -la tc
	@./tc
...
l: c
	@clang -DAW=0 -DNOLIBC=1 src/?.[c] -ol $O $(WL) $A -O0 -g -Wno-format -Wno-format-pedantic -Wno-incompatible-library-redeclaration
	@#strip l
	@#ls -la l
	@#./l
